        ...
        <React.Fragment>
            <Card style={{ paddingBottom: '0px', marginBottom: '0px',}}>
                <Card.Body className="py-2">
                    <Marquee gradient={false} speed={50} style={{marginTop: '80px'}}>
                        <div className='d-flex align-items-center'>
                            <h5 className='mx-2 mb-0 mt-0 text-warning'>Total Farms : 140 </h5> ||
                            <h5 className='mx-2 mb-0 mt-0 text-info'>Total Farmers : 230</h5>||
                            <h5 className='mx-2 mb-0 mt-0 text-danger'>Total Orders : 440</h5>||
                            <h5 className='mx-2 mb-0 mt-0 text-primary'>Total Pending Orders : 30</h5>||
                            <h5 className='mx-2 mb-0 mt-0 text-info'>Total Farmers : 230</h5>||
                            <h5 className='mx-2 mb-0 mt-0 text-danger'>Total Orders : 440</h5>||
                            <h5 className='mx-2 mb-0 mt-0 text-primary'>Total Pending Orders : 30</h5>||
                            <h5 className='mx-2 mb-0 mt-0 text-info'>Total Farmers : 230</h5>||
