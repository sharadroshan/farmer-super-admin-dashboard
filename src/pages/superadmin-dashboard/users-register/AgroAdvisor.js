    ...
    <>
      <PageTitle
        breadCrumbItems={[
          ...
          {
            label: "Agro Advisor Registration",
            path: "/agro-advisor-reg",
            active: true,
          },
        ]}
        title={"Agro Advisor Registration"}
      />
      <Card>
        <Card.Body>
          <h4 className="header-title mb-3 text-info">Agro Advisor Registration</h4>
          <Form onSubmit={(e) => e.preventDefault()}>
            <Row>
              <Form.Group as={Col} md={4} className="mb-2">
                <Form.Label>Farm Name</Form.Label>
                <Form.Control type="name" placeholder="Enter Farm Name" />
              </Form.Group>
              <Form.Group as={Col} md={4} className="mb-2">
              ...
              <Form.Group as={Col} md={4} className="mb-2">
                ...
                <Form.Control type="number" placeholder="Enter Owner Number" />
              </Form.Group>
