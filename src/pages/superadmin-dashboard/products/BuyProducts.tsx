            ...
            <div className="product-img">
                ...
                <div className="product-action">
                    <div className="d-flex">
                        <Link to="/farmer/product-details" className="btn btn-primary  d-block w-100 action-btn m-2 rounded-pill waves-effect waves-light mt-3">
                            <i className="ri-eye-fill align-middle"></i> View
                        </Link>
                        <Link to="#" className="btn text-white d-block w-100 action-btn m-2 rounded-pill waves-effect waves-light btn bg-gradient-danger mt-3">
                            <i className="ri-add-fill align-middle"></i> Delete
                        </Link>
                    </div>
                </div>
            </div>
                ...
                <Col>
                    <Card className="bg-gradient-info">
                        <Card.Body>
                            ...
                            <h3 className='text-white mt-2 font-24'><strong>300 +</strong></h3>
                        </Card.Body>
                    </Card>
                </Col>
                <Col>
                    <Card className="bg-primary">
                        <Card.Body>
                            <h5 className="text-white">Total Featured Products</h5>
                            <h3 className='text-white mt-2 font-24'><strong>50 +</strong></h3>
                        </Card.Body>
                    </Card>
                </Col>
                <Col>
                    <Card className="bg-gradient-info">
                        <Card.Body>
                            <h5 className="text-white">Total Deals Products</h5>
                            <h3 className='text-white mt-2 font-24'><strong>30 +</strong></h3>
                        </Card.Body>
                    </Card>
                </Col>
                <Col>
                    <Card className="bg-primary">
                        <Card.Body>
                            <h5 className="text-white">Total Published Products</h5>
                            <h3 className='text-white mt-2 font-24'><strong>200 +</strong></h3>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
