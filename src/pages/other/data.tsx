...
const AdvisorPricingPlans: PlanItemsTypes[] = [
    {
        id: 1,
        name: 'Starter Pack',
        icon: 'fe-at-sign',
        price: 2000,
        duration: 'Month',
        features: ['Single Consultation', 'Single Consultation'],
        isPopular: false,
    },
    {
        id: 1,
        ...
        price: 4000,
        duration: 'Month',
        features: ['2 x Single Consultation', '2x Single Consultation'],
        isPopular: true,
    },
    {
        id: 2,
        ...
        duration: 'Month',
        features: [
            '3 x Single Consultation', '3x Single Consultation'
        ],
        isPopular: false,
    },
];
...
export { invoiceData, pricingPlans,AdvisorPricingPlans, maintenanceQuery, generalFaqs, privacyFaqs, supportFaqs };
